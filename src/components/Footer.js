  ...
  return (
    <section className='bg-light-blue mx-auto'>
      <div className='px-5 sm:px-5 md:px-5 lg:px-0 mx-w-4xl sm:max-w-4xl md:max-w-6xl lg:min-w-1000 w-full mx-auto p-4 flex flex-row flex-wrap justify-between items-center'>
        <div id='images' className='flex flex-row gap-9'>
          <Image src='/wetdry.png' alt='wet&dry' className='w-full h-36 object-contain' height={500} width={500} />
          <Image src='/ecolabel.png' alt='ecolabel' className='w-full h-36 object-contain' height={500} width={500} />
        </div>
