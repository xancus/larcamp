  ...
  return (
    <section className='mb-8 bg-gray-100 h-screen'>
      ...
      <div className='sm:max-w-4xl px-5 sm:px-5 md:px-5 lg:px-0 md:max-w-4xl lg:max-w-5xl lg:max-w-7xl mx-auto'>
        <div className='bg-white border-gray-300 border mt-4'>
          ...
          <div className='flex flex-col flex-wrap items-end'>
            ...
            <Link href='/contact'  className='md:w-auto bg-teal-100 text-black py-1 px-3 mr-8 mb-6 rounded-md hover:scale-110 transition duration-300'>Tramitar pedido</Link>
