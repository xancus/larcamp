export default function avisoLegal () {
  return (
    <div>
      ...
      En el momento en que accedas a este sitio web https://larcampsl.com, asumes la condición de usuario, por lo que el contenido de este Aviso Legal te afecta directamente. Por eso, es importante que lo leas para disipar cualquier duda que puedas tener y tener conocimiento de causa sobre las condiciones que estás aceptando.
      ...
      NIF:  B-61765913
      Domicilio Social: C/ Circumvalació baixa, 16, 08290 Cerdanyola del Vallès
      Actividad del sitio web: Recomendación de productos de afiliado.
      Correo electrónico: larcamp@gmail.com
      Registro mercanti: Larcamp S.L.U, inscrito en el registro Mercantil de Barcelona, tomo 31072, folio 38, hoja B 185792, Inscripción 1
      Teléfono: 936925871
      ...
      Como titular de este sitio web, LARCAMP no garantiza que los contenidos sean precisos o libres de error o que el libre uso de los mismos por parte de los usuarios no infrinja los derechos de terceras partes. El buen o mal uso de esta página y de sus contenidos es responsabilidad del usuario.

      Asimismo, queda prohibida la reproducción, retransmisión, copia, cesión o redifusión, total o parcial, de la información contenida en la página, cualquiera que fuera su finalidad y el medio utilizado para ello, sin autorización previa de LARCAMP.

      ENLACES O LINKS

      Este sitio web incluye enlaces o links a sitios de terceros. Las páginas pertenecientes a estos terceros no han sido revisadas ni son objeto de controles por nuestra parte, por lo que LARCAMP no podrá ser considerado responsable de los contenidos de estos sitios web, ni de las medidas que se adopten relativas a su privacidad o al tratamiento de sus datos de carácter personal u otros que pudieran derivarse.
      ...
      Esto quiere decir que encontrarás enlaces de productos de Amazon a los que podrás acceder directamente desde nuestro sitio web pero que, en su caso, la compra la realizarás en Amazon, bajo sus propias condiciones en ese momento.

      LIMITACIÓN DE RESPONSABILIDAD

      En ejercicio de su derecho como titular de esta web, te informamos de que LARCAMP no se hace responsable en ningún caso de lo siguiente:
